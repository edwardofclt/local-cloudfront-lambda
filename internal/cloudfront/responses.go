...
func writeResponseHeadersV2(w http.ResponseWriter, respData types.CfResponse) {
	if respData.Headers == nil {
		return
	}
...
func validateResponseV2(eventType types.EventType, reqData types.RequestPayload, respData types.CfResponse) error {
	if respData.Headers != nil {
